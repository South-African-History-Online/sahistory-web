...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // WebP conversion DISABLED - server-side .htaccess rules handle this automatically.
  // Client-side conversion was causing double downloads (JPG + WebP) which hurt
  // performance in Google PageSpeed Insights.
  // The .htaccess rules automatically serve .webp files when:
  // 1. Browser supports WebP (checks Accept header)
  // 2. Request is for .jpg/.jpeg/.png
  // 3. Corresponding .webp file exists
  // This happens transparently without JavaScript and avoids downloading both versions.
  //
