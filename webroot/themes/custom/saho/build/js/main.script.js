...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var mobileToggle = document.querySelector('.saho-mobile-toggle');
  var mobileMenu = document.getElementById('sahoMobileMenu');
  if (mobileToggle && mobileMenu) {
    // Fix for iOS devices where the menu might go off-screen
    var fixIOSViewport = function fixIOSViewport() {
    ...
    var offcanvasInstance = new bootstrap.Offcanvas(mobileMenu, {
      backdrop: true,
      keyboard: true,
      scroll: false
    });
    ...
    document.addEventListener('click', function (e) {
      if (mobileMenu.classList.contains('show') && !mobileMenu.contains(e.target) && e.target !== mobileToggle && !mobileToggle.contains(e.target)) {
        offcanvasInstance.hide();
      }
    });
    fixIOSViewport();
  ...
  var copyShareUrlBtn = document.getElementById('copyShareUrl');
  if (copyShareUrlBtn) {
      ...
      if (shareUrlInput) {
        ...
        try {
          ...
          setTimeout(function () {
            ...
            _this.classList.add('btn-outline-secondary');
          }, 2000);
        } catch (err) {
...
/***/ "./components/local-tasks/local-tasks.scss":
/*!*************************************************!*\
  !*** ./components/local-tasks/local-tasks.scss ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 			"components/local-tasks/local-tasks": 0,
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksaho"] = self["webpackChunksaho"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["build/css/main.style","components/nav-item/nav-item","components/local-tasks/local-tasks","components/carousel/carousel","components/block/block","components/region/region","components/page/page","components/page-navigation/page-navigation","components/page-footer/page-footer","components/page-content/page-content","components/navbar/navbar","components/navbar-brand/navbar-brand","components/nav/nav"], function() { return __webpack_require__("./src/js/main.script.js"); })
/******/ 	__webpack_require__.O(undefined, ["build/css/main.style","components/nav-item/nav-item","components/local-tasks/local-tasks","components/carousel/carousel","components/block/block","components/region/region","components/page/page","components/page-navigation/page-navigation","components/page-footer/page-footer","components/page-content/page-content","components/navbar/navbar","components/navbar-brand/navbar-brand","components/nav/nav"], function() { return __webpack_require__("./src/scss/main.style.scss"); })
/******/ 	__webpack_require__.O(undefined, ["build/css/main.style","components/nav-item/nav-item","components/local-tasks/local-tasks","components/carousel/carousel","components/block/block","components/region/region","components/page/page","components/page-navigation/page-navigation","components/page-footer/page-footer","components/page-content/page-content","components/navbar/navbar","components/navbar-brand/navbar-brand","components/nav/nav"], function() { return __webpack_require__("./components/block/block.scss"); })
/******/ 	__webpack_require__.O(undefined, ["build/css/main.style","components/nav-item/nav-item","components/local-tasks/local-tasks","components/carousel/carousel","components/block/block","components/region/region","components/page/page","components/page-navigation/page-navigation","components/page-footer/page-footer","components/page-content/page-content","components/navbar/navbar","components/navbar-brand/navbar-brand","components/nav/nav"], function() { return __webpack_require__("./components/carousel/carousel.scss"); })
/******/ 	__webpack_require__.O(undefined, ["build/css/main.style","components/nav-item/nav-item","components/local-tasks/local-tasks","components/carousel/carousel","components/block/block","components/region/region","components/page/page","components/page-navigation/page-navigation","components/page-footer/page-footer","components/page-content/page-content","components/navbar/navbar","components/navbar-brand/navbar-brand","components/nav/nav"], function() { return __webpack_require__("./components/local-tasks/local-tasks.scss"); })
/******/ 	__webpack_require__.O(undefined, ["build/css/main.style","components/nav-item/nav-item","components/local-tasks/local-tasks","components/carousel/carousel","components/block/block","components/region/region","components/page/page","components/page-navigation/page-navigation","components/page-footer/page-footer","components/page-content/page-content","components/navbar/navbar","components/navbar-brand/navbar-brand","components/nav/nav"], function() { return __webpack_require__("./components/nav-item/nav-item.scss"); })
/******/ 	__webpack_require__.O(undefined, ["build/css/main.style","components/nav-item/nav-item","components/local-tasks/local-tasks","components/carousel/carousel","components/block/block","components/region/region","components/page/page","components/page-navigation/page-navigation","components/page-footer/page-footer","components/page-content/page-content","components/navbar/navbar","components/navbar-brand/navbar-brand","components/nav/nav"], function() { return __webpack_require__("./components/nav/nav.scss"); })
/******/ 	__webpack_require__.O(undefined, ["build/css/main.style","components/nav-item/nav-item","components/local-tasks/local-tasks","components/carousel/carousel","components/block/block","components/region/region","components/page/page","components/page-navigation/page-navigation","components/page-footer/page-footer","components/page-content/page-content","components/navbar/navbar","components/navbar-brand/navbar-brand","components/nav/nav"], function() { return __webpack_require__("./components/navbar-brand/navbar-brand.scss"); })
/******/ 	__webpack_require__.O(undefined, ["build/css/main.style","components/nav-item/nav-item","components/local-tasks/local-tasks","components/carousel/carousel","components/block/block","components/region/region","components/page/page","components/page-navigation/page-navigation","components/page-footer/page-footer","components/page-content/page-content","components/navbar/navbar","components/navbar-brand/navbar-brand","components/nav/nav"], function() { return __webpack_require__("./components/navbar/navbar.scss"); })
/******/ 	__webpack_require__.O(undefined, ["build/css/main.style","components/nav-item/nav-item","components/local-tasks/local-tasks","components/carousel/carousel","components/block/block","components/region/region","components/page/page","components/page-navigation/page-navigation","components/page-footer/page-footer","components/page-content/page-content","components/navbar/navbar","components/navbar-brand/navbar-brand","components/nav/nav"], function() { return __webpack_require__("./components/page-content/page-content.scss"); })
/******/ 	__webpack_require__.O(undefined, ["build/css/main.style","components/nav-item/nav-item","components/local-tasks/local-tasks","components/carousel/carousel","components/block/block","components/region/region","components/page/page","components/page-navigation/page-navigation","components/page-footer/page-footer","components/page-content/page-content","components/navbar/navbar","components/navbar-brand/navbar-brand","components/nav/nav"], function() { return __webpack_require__("./components/page-footer/page-footer.scss"); })
/******/ 	__webpack_require__.O(undefined, ["build/css/main.style","components/nav-item/nav-item","components/local-tasks/local-tasks","components/carousel/carousel","components/block/block","components/region/region","components/page/page","components/page-navigation/page-navigation","components/page-footer/page-footer","components/page-content/page-content","components/navbar/navbar","components/navbar-brand/navbar-brand","components/nav/nav"], function() { return __webpack_require__("./components/page-navigation/page-navigation.scss"); })
/******/ 	__webpack_require__.O(undefined, ["build/css/main.style","components/nav-item/nav-item","components/local-tasks/local-tasks","components/carousel/carousel","components/block/block","components/region/region","components/page/page","components/page-navigation/page-navigation","components/page-footer/page-footer","components/page-content/page-content","components/navbar/navbar","components/navbar-brand/navbar-brand","components/nav/nav"], function() { return __webpack_require__("./components/page/page.scss"); })
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["build/css/main.style","components/nav-item/nav-item","components/local-tasks/local-tasks","components/carousel/carousel","components/block/block","components/region/region","components/page/page","components/page-navigation/page-navigation","components/page-footer/page-footer","components/page-content/page-content","components/navbar/navbar","components/navbar-brand/navbar-brand","components/nav/nav"], function() { return __webpack_require__("./components/region/region.scss"); })
