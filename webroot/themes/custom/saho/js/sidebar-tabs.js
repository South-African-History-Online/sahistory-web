...
(function ($, Drupal, once) {
  ...
  Drupal.behaviors.sahoSidebarTabs = {
    attach: function (context, settings) {
      once('saho-sidebar-tabs', '.saho-sidebar-tabs', context).forEach(function (element) {
  ...
  function updateTabBadges($container) {
    ...
    $buttons.each(function () {
      ...
      const $contentSections = $pane.find('.saho-content-group, .saho-taxonomy-section, .saho-resource-section');
  ...
  function setupResponsiveTabs($container) {
    ...
    $(window).on('resize.sahoTabs', debounce(function () {
  ...
  Drupal.sahoTabs = {
     ...
     */
    getActive: function (containerId) {
      const $container = $('#' + containerId);
