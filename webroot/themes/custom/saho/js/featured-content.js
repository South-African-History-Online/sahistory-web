...
(function ($, Drupal) {
  ...
  function loadStaffPicks() {
    ...
    if (count > 0) {
      ...
      $container.html('<div class="col-12"><div class="alert alert-info">No staff picks available.</div></div>');
    }
  }
  ...
  function loadMostRead() {
    ...
    if (count > 0) {
      ...
      $container.html('<div class="col-12"><div class="alert alert-info">Statistics module not configured yet.</div></div>');
    }
  }
