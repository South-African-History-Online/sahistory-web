...
- **Status:**  BORDERLINE (below AA for small text)
...
#### Modals
- **Focus Trap:** Focus stays within modal  (needs JS validation)
- **Return Focus:** Returns to trigger on close  (needs JS validation)
...
-  Icon labels: SVG icons use currentColor (good) but may need aria-label
...
-  Focus trap:  Requires JavaScript validation
-  Escape key: Closes modal
...
| Success | #22c55e | 3.82:1 |  (Borderline) |
